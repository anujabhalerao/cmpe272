...
public class Temp extends Activity implements OnClickListener, ConnectionCallbacks, OnConnectionFailedListener {
        ...
        switch (requestCode) {
            case RC_SIGN_IN:
                if (responseCode == RESULT_OK) {
                    signedInUser = false;
                    Intent device = new Intent(Temp.this,DeviceListActivity.class);
                    startActivity(device);

                }
                else if(responseCode == RESULT_CANCELED){
                    signedInUser = false;
                    Intent device = new Intent(Temp.this,DevicesActivity.class);
                    startActivity(device);
                }
                mIntentInProgress = false;
